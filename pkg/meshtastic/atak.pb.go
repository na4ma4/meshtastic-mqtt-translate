...
// 	protoc        v6.33.1
// source: github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/atak.proto
...
func (Team) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes[0].Descriptor()
}

func (Team) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes[0]
}
...
func (Team) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{0}
}
...
func (MemberRole) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes[1].Descriptor()
}

func (MemberRole) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes[1]
}
...
func (MemberRole) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{1}
}
...
func (x *TAKPacket) Reset() {
	*x = TAKPacket{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[0]
...
func (x *GeoChat) Reset() {
	*x = GeoChat{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Group) Reset() {
	*x = Group{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Group) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{2}
}
...
func (x *Status) Reset() {
	*x = Status{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{3}
}
...
func (x *Contact) Reset() {
	*x = Contact{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Contact) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{4}
}
...
func (x *PLI) Reset() {
	*x = PLI{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PLI) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP(), []int{5}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDesc = "" +
	"\n" +
	"Egithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/atak.proto\x12\n" +
	"meshtastic\"\xb1\x02\n" +
	"\tTAKPacket\x12#\n" +
	...
	"ATAKProtosZ:github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto != nil {
		return
	}
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[0].OneofWrappers = []any{
		(*TAKPacket_Pli)(nil),
		(*TAKPacket_Chat)(nil),
		(*TAKPacket_Detail)(nil),
	}
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_depIdxs,
		EnumInfos:         file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_enumTypes,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_atak_proto_depIdxs = nil
}
