...
// 	protoc        v6.33.0
// source: github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/mqtt.proto
...
func (x *ServiceEnvelope) Reset() {
	*x = ServiceEnvelope{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_msgTypes[0]
...
func (*ServiceEnvelope) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescGZIP(), []int{0}
}
...
func (x *MapReport) Reset() {
	*x = MapReport{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MapReport) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescGZIP(), []int{1}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDesc = "" +
	"\n" +
	"Ggithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/mqtt.proto\x12\n" +
	"meshtastic\x1aIgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/config.proto\x1aGgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/mesh.proto\"\x7f\n" +
	...
	"\x19has_opted_report_location\x18\x0e \x01(\bR\x16hasOptedReportLocationBz\n" +
	"\x14org.meshtastic.protoB\n" +
	"MQTTProtosZ<github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_depIdxs,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mqtt_proto_depIdxs = nil
}
