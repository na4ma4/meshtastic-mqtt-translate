...
// 	protoc        v6.33.1
// source: github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/storeforward.proto
...
func (StoreAndForward_RequestResponse) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_enumTypes[0].Descriptor()
}

func (StoreAndForward_RequestResponse) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_enumTypes[0]
}
...
func (StoreAndForward_RequestResponse) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *StoreAndForward) Reset() {
	*x = StoreAndForward{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes[0]
...
func (*StoreAndForward) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescGZIP(), []int{0}
}
...
func (x *StoreAndForward_Statistics) Reset() {
	*x = StoreAndForward_Statistics{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *StoreAndForward_History) Reset() {
	*x = StoreAndForward_History{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StoreAndForward_History) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *StoreAndForward_Heartbeat) Reset() {
	*x = StoreAndForward_Heartbeat{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StoreAndForward_Heartbeat) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescGZIP(), []int{0, 2}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDesc = "" +
	"\n" +
	"Mgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/storeforward.proto\x12\n" +
	"meshtastic\"\xec\b\n" +
	...
	"\fCLIENT_ABORT\x10jB\t\n" +
	"\avariantB\x83\x01\n" +
	"\x14org.meshtastic.protoB\x15StoreAndForwardProtosZ:github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_depIdxs = []int32{
...
func init() {
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_init()
}
func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto != nil {
		return
	}
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_depIdxs,
		EnumInfos:         file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_enumTypes,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_storeforward_proto_depIdxs = nil
}
