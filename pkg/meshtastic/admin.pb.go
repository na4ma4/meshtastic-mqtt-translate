...
// 	protoc        v6.33.0
// source: github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/admin.proto
...
func (AdminMessage_ConfigType) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[0].Descriptor()
}

func (AdminMessage_ConfigType) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[0]
}
...
func (AdminMessage_ConfigType) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{0, 0}
}
...
func (AdminMessage_ModuleConfigType) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[1].Descriptor()
}

func (AdminMessage_ModuleConfigType) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[1]
}
...
func (AdminMessage_ModuleConfigType) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{0, 1}
}
...
func (AdminMessage_BackupLocation) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[2].Descriptor()
}

func (AdminMessage_BackupLocation) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[2]
}
...
func (AdminMessage_BackupLocation) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{0, 2}
}
...
func (KeyVerificationAdmin_MessageType) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[3].Descriptor()
}

func (KeyVerificationAdmin_MessageType) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes[3]
}
...
func (KeyVerificationAdmin_MessageType) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *AdminMessage) Reset() {
	*x = AdminMessage{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[0]
...
func (*AdminMessage) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{0}
}
...
func (x *HamParameters) Reset() {
	*x = HamParameters{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HamParameters) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{1}
}
...
func (x *NodeRemoteHardwarePinsResponse) Reset() {
	*x = NodeRemoteHardwarePinsResponse{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeRemoteHardwarePinsResponse) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{2}
}
...
func (x *SharedContact) Reset() {
	*x = SharedContact{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SharedContact) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{3}
}
...
func (x *KeyVerificationAdmin) Reset() {
	*x = KeyVerificationAdmin{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeyVerificationAdmin) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP(), []int{4}
}
...
func (x *AdminMessage_InputEvent) Reset() {
	*x = AdminMessage_InputEvent{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDesc = "" +
	"\n" +
	"Hgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/admin.proto\x12\n" +
	"meshtastic\x1aJgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/channel.proto\x1aIgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/config.proto\x1aTgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/connection_status.proto\x1aLgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/device_ui.proto\x1aGgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/mesh.proto\x1aPgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/module_config.proto\"\xd3!\n" +
	"\fAdminMessage\x12'\n" +
	...
	"\x14org.meshtastic.protoB\vAdminProtosZ<github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto != nil {
		return
	}
	...
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_init()
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_init()
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_mesh_proto_init()
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_module_config_proto_init()
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_depIdxs,
		EnumInfos:         file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_enumTypes,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_admin_proto_depIdxs = nil
}
