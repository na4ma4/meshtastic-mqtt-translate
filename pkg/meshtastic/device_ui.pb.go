...
// 	protoc        v6.33.0
// source: github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/device_ui.proto
...
func (CompassMode) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[0].Descriptor()
}

func (CompassMode) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[0]
}
...
func (CompassMode) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{0}
}
...
func (Theme) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[1].Descriptor()
}

func (Theme) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[1]
}
...
func (Theme) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{1}
}
...
func (Language) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[2].Descriptor()
}

func (Language) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[2]
}
...
func (Language) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{2}
}
...
func (DeviceUIConfig_GpsCoordinateFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[3].Descriptor()
}

func (DeviceUIConfig_GpsCoordinateFormat) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes[3]
}
...
func (DeviceUIConfig_GpsCoordinateFormat) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *DeviceUIConfig) Reset() {
	*x = DeviceUIConfig{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes[0]
...
func (x *NodeFilter) Reset() {
	*x = NodeFilter{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NodeHighlight) Reset() {
	*x = NodeHighlight{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GeoPoint) Reset() {
	*x = GeoPoint{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeoPoint) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{3}
}
...
func (x *Map) Reset() {
	*x = Map{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Map) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP(), []int{4}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDesc = "" +
	"\n" +
	"Lgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/device_ui.proto\x12\n" +
	"meshtastic\"\xb7\a\n" +
	...
	"\x14org.meshtastic.protoB\x0eDeviceUIProtosZ<github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_depIdxs,
		EnumInfos:         file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_enumTypes,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_device_ui_proto_depIdxs = nil
}
