...
// 	protoc        v6.33.1
// source: github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/deviceonly.proto

package meshtastic

import (
	_ "github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic_core"
...
func (x *PositionLite) Reset() {
	*x = PositionLite{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[0]
...
func (*PositionLite) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{0}
}
...
type UserLite struct {
	...
	//
	// Deprecated: Marked as deprecated in github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/deviceonly.proto.
...
func (x *UserLite) Reset() {
	*x = UserLite{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserLite) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{1}
}
...
func (x *NodeInfoLite) Reset() {
	*x = NodeInfoLite{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeInfoLite) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{2}
}
...
func (x *DeviceState) Reset() {
	*x = DeviceState{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceState) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{3}
}
...
func (x *NodeDatabase) Reset() {
	*x = NodeDatabase{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeDatabase) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{4}
}
...
func (x *ChannelFile) Reset() {
	*x = ChannelFile{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChannelFile) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{5}
}
...
func (x *BackupPreferences) Reset() {
	*x = BackupPreferences{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BackupPreferences) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP(), []int{6}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDesc = "" +
	"\n" +
	"Kgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/deviceonly.proto\x12\n" +
	"meshtastic\x1aHgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/channel.proto\x1aGgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/config.proto\x1aJgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/localonly.proto\x1aEgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/mesh.proto\x1aJgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/telemetry.proto\x1aLgithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic_core/nanopb.proto\"\xc7\x01\n" +
	...
	"\x05owner\x18\x06 \x01(\v2\x10.meshtastic.UserR\x05ownerB\x86\x01\x92?\v\xc2\x01\b<vector>\n" +
	"\x14org.meshtastic.protoB\n" +
	"DeviceOnlyZ:github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto != nil {
		return
	}
	...
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_localonly_proto_init()
	...
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[1].OneofWrappers = []any{}
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_depIdxs,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_deviceonly_proto_depIdxs = nil
}
