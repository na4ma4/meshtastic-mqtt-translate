...
// 	protoc        v6.33.0
// source: github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/connection_status.proto
...
func (x *DeviceConnectionStatus) Reset() {
	*x = DeviceConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[0]
...
func (*DeviceConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{0}
}
...
func (x *WifiConnectionStatus) Reset() {
	*x = WifiConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WifiConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{1}
}
...
func (x *EthernetConnectionStatus) Reset() {
	*x = EthernetConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EthernetConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{2}
}
...
func (x *NetworkConnectionStatus) Reset() {
	*x = NetworkConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NetworkConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{3}
}
...
func (x *BluetoothConnectionStatus) Reset() {
	*x = BluetoothConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BluetoothConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{4}
}
...
func (x *SerialConnectionStatus) Reset() {
	*x = SerialConnectionStatus{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SerialConnectionStatus) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP(), []int{5}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDesc = "" +
	"\n" +
	"Tgithub.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic/connection_status.proto\x12\n" +
	"meshtastic\"\xd4\x02\n" +
	...
	"\fis_connected\x18\x02 \x01(\bR\visConnectedB\x80\x01\n" +
	"\x14org.meshtastic.protoB\x10ConnStatusProtosZ<github.com/na4ma4/meshtastic-mqtt-bin-to-json/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_depIdxs = []int32{
...
func file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto != nil {
		return
	}
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_depIdxs,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_bin_to_json_pkg_meshtastic_connection_status_proto_depIdxs = nil
}
