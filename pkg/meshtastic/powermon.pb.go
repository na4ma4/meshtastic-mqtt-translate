...
// 	protoc        v6.33.1
// source: github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/powermon.proto
...
func (PowerMon_State) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes[0].Descriptor()
}

func (PowerMon_State) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes[0]
}
...
func (PowerMon_State) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescGZIP(), []int{0, 0}
}
...
func (PowerStressMessage_Opcode) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes[1].Descriptor()
}

func (PowerStressMessage_Opcode) Type() protoreflect.EnumType {
	return &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes[1]
}
...
func (PowerStressMessage_Opcode) EnumDescriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *PowerMon) Reset() {
	*x = PowerMon{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_msgTypes[0]
...
func (*PowerMon) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescGZIP(), []int{0}
}
...
func (x *PowerStressMessage) Reset() {
	*x = PowerStressMessage{}
	mi := &file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PowerStressMessage) Descriptor() ([]byte, []int) {
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescGZIP(), []int{1}
}
...
var File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto protoreflect.FileDescriptor

const file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDesc = "" +
	"\n" +
	"Igithub.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic/powermon.proto\x12\n" +
	"meshtastic\"\xe0\x01\n" +
	"\bPowerMon\"\xd3\x01\n" +
	"\x05State\x12\b\n" +
	...
	"\n" +
	"\x06GPS_ON\x10qB|\n" +
	"\x14org.meshtastic.protoB\x0ePowerMonProtosZ:github.com/na4ma4/meshtastic-mqtt-translate/pkg/meshtastic\xaa\x02\x14Meshtastic.Protobufs\xba\x02\x00b\x06proto3"

var (
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescOnce sync.Once
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescData []byte
)

func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescGZIP() []byte {
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescOnce.Do(func() {
		file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDesc)))
	})
	return file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDescData
}

var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_goTypes = []any{
...
var file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_depIdxs = []int32{
...
func init() { file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_init() }
func file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_init() {
	if File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDesc), len(file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_goTypes,
		DependencyIndexes: file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_depIdxs,
		EnumInfos:         file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_enumTypes,
		MessageInfos:      file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_msgTypes,
	}.Build()
	File_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto = out.File
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_goTypes = nil
	file_github_com_na4ma4_meshtastic_mqtt_translate_pkg_meshtastic_powermon_proto_depIdxs = nil
}
